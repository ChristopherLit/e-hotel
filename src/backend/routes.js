...
import { get_hotel_chain, get_hotel_chain_by_id, get_hotel_chain_ids, get_hotel_by_filters, check_customer_ssn, 
    ...
    get_hotel_count, delete_booking, update_booking, create_customer_account, getTotalRevenue, get_rooms_per_area, get_hotel_cities, get_aggregatedCapacity } from './controller.js';
